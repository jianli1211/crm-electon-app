// TODO: Move to constants folder later after migration
...
export const countriesContinents = [
  { code: 'AD', label: 'Andorra', phone: '376' },
  {
    code: 'AE',
    label: 'United Arab Emirates',
  ...
  { code: 'GCC', flag: "https://flagcdn.com/org/w20/gcc.png", flag2x: "https://flagcdn.com/org/w40/gcc.png 2x", label: 'Gulf Cooperation Council' },
  { code: 'AFRICA', flag: "https://flagcdn.com/org/w20/au.png", flag2x: "https://flagcdn.com/org/w40/au.png 2x", label: 'Africa' },
  { code: 'NORDIC', flag: "https://flagcdn.com/org/w20/nc.png", flag2x: "https://flagcdn.com/org/w40/nc.png 2x", label: 'Nordic' },
  { code: 'LATIN', label: 'Latin America' },
...
export const formLangList = [
  { code: 'fr', name: 'French', icon: 'circle-flags:fr' },
  { code: 'de', name: 'German', icon: 'circle-flags:de' },
  { code: 'ar', name: 'Arabic', icon: 'circle-flags:sa' },
  { code: 'ru', name: 'Russian', icon: 'circle-flags:ru' },
  { code: 'es', name: 'Spanish', icon: 'circle-flags:es' },
  { code: 'nl', name: 'Dutch', icon: 'circle-flags:nl' },
  { code: 'it', name: 'Italian', icon: 'circle-flags:it' },
  { code: 'tr', name: 'Turkish', icon: 'circle-flags:tr' }
];
