...
import { IBActiveFilter } from "./filters/ib-active-filter";
...
export const useGetCustomerColumns = ({
  ...
  const updateFilters = (data) => {
    data.currentPage = 0;
    onDeselectAll();
    dispatch(thunks.setIBsFilters(data));
  };

  const handleClick = (id) => {
    if (customFilters?.length !== 0) {
      dispatch(slice.actions.setIBsCustomFilter(customFilters));
    }
    navigate(`${paths.dashboard.customers.index}/${id}?${searchParam?.toString()}`, { state: { prevRouter: "ibs" } });
  };
  ...
  const DEFAULT_COLUMN = [
    ...
    },
    {
      ...
      enabled: true,
      headerRender: () => (
        <IBActiveFilter updateFilters={updateFilters} />
      ),
      render: (row) => (
        <Stack direction="row">
          {row?.is_active_ib ? (
    ...
    },
    {
      ...
      headerRender: () => (
        <FilterInput
          label="Network Size"
          type="number"
          placeholder="Min Network Size..."
          filter={filters?.total_network_size}
          setFilter={(val) => {
            updateFilters({ total_network_size: val });
          }}
          isRange
          placeholder2="Max Network Size..."
          filter2={filters?.lte_total_network_size}
          setFilter2={(val) => {
            updateFilters({ lte_total_network_size: val });
          }}
        />
      ),
      render: (row) => (
        <Typography sx={{ whiteSpace: "nowrap" }}>
          {row?.total_network_size}
        </Typography>
      ),
    },
    {
      ...
      headerRender: () => (
        <FilterInput
          label="IB Name"
          placeholder="IB Name..."
          filter={filters?.ib_name}
          setFilter={(val) => {
            updateFilters({ ib_name: val });
          }}
        />
      ),
      render: (row) => (
    ...
    },
    {
      ...
      headerRender: () => (
        <FilterInput
          ...
          type="number"
          placeholder="IB ID..."
          filter={filters?.ib_id}
          setFilter={(val) => {
            updateFilters({ ib_id: val });
          }}
        />
      ),
      render: (row) => (
    ...
    },
    {
      ...
      headerRender: () => (
        <FilterInput
          ...
          type="number"
          placeholder="Min L1..."
          filter={filters?.l1_referrals_count}
          setFilter={(val) => {
            updateFilters({ l1_referrals_count: val });
          }}
          isRange
          placeholder2="Max L1..."
          filter2={filters?.lte_l1_referrals_count}
          setFilter2={(val) => {
            updateFilters({ lte_l1_referrals_count: val });
          }}
        />
      ),
      render: (row) => (
        <Typography sx={{ whiteSpace: "nowrap" }}>
          {row?.l1_referrals_count}
        </Typography>
      ),
    },
    {
      ...
      headerRender: () => (
        <FilterInput
          ...
          type="number"
          placeholder="Min L2..."
          filter={filters?.l2_referrals_count}
          setFilter={(val) => {
            updateFilters({ l2_referrals_count: val });
          }}
          isRange
          placeholder2="Max L2..."
          filter2={filters?.lte_l2_referrals_count}
          setFilter2={(val) => {
            updateFilters({ lte_l2_referrals_count: val });
          }}
        />
      ),
      render: (row) => (
        <Typography sx={{ whiteSpace: "nowrap" }}>
          {row?.l2_referrals_count}
        </Typography>
      ),
    },
    {
      ...
      headerRender: () => (
        <FilterInput
          ...
          type="number"
          placeholder="Min L3..."
          filter={filters?.l3_referrals_count}
          setFilter={(val) => {
            updateFilters({ l3_referrals_count: val });
          }}
          isRange
          placeholder2="Max L3..."
          filter2={filters?.lte_l3_referrals_count}
          setFilter2={(val) => {
            updateFilters({ lte_l3_referrals_count: val });
          }}
        />
      ),
      render: (row) => (
        <Typography sx={{ whiteSpace: "nowrap" }}>
          {row?.l3_referrals_count}
        </Typography>
      ),
    },
    {
      ...
      headerRender: () => (
        <FilterInput
          ...
          type="number"
          placeholder="Min L4..."
          filter={filters?.l4_referrals_count}
          setFilter={(val) => {
            updateFilters({ l4_referrals_count: val });
          }}
          isRange
          placeholder2="Max L4..."
          filter2={filters?.lte_l4_referrals_count}
          setFilter2={(val) => {
            updateFilters({ lte_l4_referrals_count: val });
          }}
        />
      ),
      render: (row) => (
        <Typography sx={{ whiteSpace: "nowrap" }}>
          {row?.l4_referrals_count}
        </Typography>
      ),
    },
    {
      ...
      headerRender: () => (
        <FilterInput
          ...
          type="number"
          placeholder="Min L5..."
          filter={filters?.l5_referrals_count}
          setFilter={(val) => {
            updateFilters({ l5_referrals_count: val });
          }}
          isRange
          placeholder2="Max L5..."
          filter2={filters?.lte_l5_referrals_count}
          setFilter2={(val) => {
            updateFilters({ lte_l5_referrals_count: val });
          }}
        />
      ),
      render: (row) => (
        <Typography sx={{ whiteSpace: "nowrap" }}>
          {row?.l5_referrals_count}
        </Typography>
      ),
    },
    {
      ...
      headerRender: () => (
        <FilterInput
          label="IB Code"
          placeholder="IB Code..."
          filter={filters?.ib_code}
          setFilter={(val) => {
            updateFilters({ ib_code: val });
          }}
        />
      ),
      render: (row) => (
    ...
    (company?.company_wallet_system !== false && user?.acc?.acc_v_active_wallets &&
      wallets?.find((w) => w?.name === "Tron")?.enabled === true) ||
      (company?.company_wallet_system !== false && user?.acc?.acc_v_inactive_wallets &&
  ...
  useEffect(() => {
    if (!columnSettings?.iBsTable && customFilters?.length) {
      const updateSetting = {
        ...columnSettings,
        iBsTable: [...DEFAULT_COLUMN, ...customFilters],
      };
      setRule(updateSetting?.iBsTable);
    } else if (!columnSettings?.iBsTable) {
      const updateSetting = {
        ...columnSettings,
        iBsTable: [...DEFAULT_COLUMN],
      };
      setRule(updateSetting?.iBsTable);
    }
